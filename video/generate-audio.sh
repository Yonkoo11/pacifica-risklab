...
clips[06-fit]="It runs on Pacifica's public API. No wallet, no authentication. This is an Analytics and Data track project."
...
clips[17-api-2]="Funding rate history powers the stress chart. The orderbook endpoint feeds the market impact model. Four endpoints, zero authentication."
